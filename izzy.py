...
while True:
    ...
    for port in range(1, 65534):
        ...
        sent = sent + 1
        time.sleep(1)
        print("\033[100m \033[7m[IMF0] \033[0m \033[97m%s  \033[33mSent \033[92m%s \033[36m" % (sent, ip))
        print("\033[97m [IMF0] \033[0m \033[36m%s  \033[32mSent \033[33m%s \033[94mPort \033[33m%s " % (sent, ip, port))
